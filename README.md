...
> You can use Python extension modules and libraries with your AWS Glue ETL scripts as long as they are written in pure Python. **C libraries such as [pandas are not supported](https://docs.aws.amazon.com/glue/latest/dg/aws-glue-programming-python-libraries.html)** at the present time, nor are extensions written in other languages.
